...
export class QuesadillasPage implements OnInit {
  ...
  quesadillas: Array<{ "productname": string, "price": number, "photoUrl": string, "stock": string }> = [
  ...
  async presentAlert(quesadilla: { productname: string; price: number; photoUrl: string, stock: string }) {
